...
<body>
    ...
    <script>
        ...
        if (vendorId) {
            axios.get(`http://localhost:3000/app/api/v1/costumer/${vendorId}`)
                .then(response => {
                    const vendor = response.data.data;

                    // Populate form fields with existing vendor data
                    document.getElementById('name').value = vendor.costumername || ''; // vendorname -> name
        ...
        document.getElementById('editVendorForm').addEventListener('submit', function(event) {
            ...
            // Get form values
            const vendorData = {
                costumername: document.getElementById('name').value,
            ...
            axios.put(`http://localhost:3000/app/api/v1/costumer/${vendorId}`, vendorData)
                .then(response => {
