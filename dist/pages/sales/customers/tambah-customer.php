...
<head>
    ...
    <title>Add Customer - Konate Dashboard</title>
...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/../../../../erp-2/dist/pages/sales/customers/list-customer.php">List Customers</a></li>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-md-6 col-12 mb-3">
                                                    <div class="form-group">
                                                        <label for="vendor-name" class="mb-2">Costumer Name</label>
                                                        <input type="text" id="vendor-name" class="form-control" name="Costumername" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12 mb-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="country" class="form-control mb-3" name="Country" placeholder="Country" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12 mb-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12 d-flex justify-content-end mt-3">
                                                    ...
                                                    <a type="reset" class="btn btn-light-secondary mb-1" href="/../../../../erp-2/dist/pages/sales/customers/list-customer.php">Cancel</a>
                                                </div>
                                            </div>
                                        </form>
    ...
    <script>
        document.getElementById("vendorForm").addEventListener("submit", function(event) {
            ...
            const formData = {
                Costumername: document.getElementById("vendor-name").value,
                ...
                status: document.querySelector('input[name="status"]:checked').value // Get selected radio button value
            };

            // Debug: log the form data to ensure it's correct
            console.log("Form Data:", formData);

            // Send data to the server using Fetch API
            fetch("http://localhost:3000/app/api/v1/costumer", {
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = "list-customer.php"; // Redirect to list customer page
                    } else {
                        window.location.href = "list-customer.php";
                    }
                })
                .catch(error => {
